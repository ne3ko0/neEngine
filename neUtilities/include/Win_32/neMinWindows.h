...
#ifdef _WINDOWS_
# pragma message ( " " )
# pragma message ( " You have included Windows.h before neMinWindows.h ")
# pragma message ( " All useless stuff from the windows headers won't be excluded !!!"
# pragma message ( " " )
#endif // _WINDOWS_

//Excludes rarely used services
#define WIN32_LEAN_AND_MEAN

//This defines remove some other services from the windows header
